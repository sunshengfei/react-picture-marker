...
> 关于[ui-picture-bd-marker@2.3.1](https://www.npmjs.com/package/ui-picture-bd-marker)插件的React组件封装
  

可参考VUE文档地址：[https://vmarker.sagocloud.com/](https://vmarker.sagocloud.com/about/)

### 项目仓库地址

[https://github.com/sunshengfei/react-picture-marker](https://github.com/sunshengfei/react-picture-marker)

### 安装

```
npm i react-picture-marker
```

或

```
npm i @sunshengfei/react-picture-marker@0.0.1
...
```
git clone https://github.com/sunshengfei/react-picture-marker
cd react-picture-marker
#修改package.json中name属性【可选】
npm i
npm i react-picture-marker 
npm run start
```
